...
;// CONCATENATED MODULE: ./components/Cards/UserEditCard.js
...
function CardSettings() {
    ...
    const fetchData = ()=>{
        fetch(`http://143.110.249.208:3000/api/user/search/${Email}`).then((response)=>response.json()
        ).then((data)=>{
            setName(data[0].name);
...
;// CONCATENATED MODULE: ./pages/admin/edit_user.js
...
/* harmony default export */ const edit_user = (add_user);
...
var __webpack_exports__ = __webpack_require__.X(0, [730,664,337], () => (__webpack_exec__(248)));
