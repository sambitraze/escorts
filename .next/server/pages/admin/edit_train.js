...
;// CONCATENATED MODULE: ./components/Cards/TrainEditCard.js
...
function CardSettings() {
    ...
    const { 0: rakeNumber , 1: setRakeNumber  } = (0,external_react_.useState)("");
    const fetchData = ()=>{
        fetch(`http://143.110.249.208:3000/api/train/${id}`).then((response)=>response.json()
        ).then((data)=>{
    ...
    const submitHandler = (e)=>{
        e.preventDefault();
        fetch(`http://143.110.249.208:3000/api/train/update/${id}`, {
            method: "PUT",
            headers: {
...
;// CONCATENATED MODULE: ./pages/admin/edit_train.js
...
/* harmony default export */ const edit_train = (add_user);
...
var __webpack_exports__ = __webpack_require__.X(0, [730,664,337], () => (__webpack_exec__(928)));
