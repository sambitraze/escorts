...
;// CONCATENATED MODULE: ./components/Cards/CoachEditCard.js
...
function CardSettings() {
    ...
    const [number, setNumber] = (0,external_react_.UseState)(0);
    const [type, setType] = (0,external_react_.UseState)("");
    const fetchData = ()=>{
        fetch(`http://143.110.249.208:3000/api/coach/${id}`).then((response)=>response.json()
        ).then((data)=>{
...
;// CONCATENATED MODULE: ./pages/admin/edit_coach.js
...
/* harmony default export */ const edit_coach = (add_user);
...
var __webpack_exports__ = __webpack_require__.X(0, [730,664,337], () => (__webpack_exec__(3146)));
